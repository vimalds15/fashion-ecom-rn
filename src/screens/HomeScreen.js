    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="mt-6 px-5">
        <View className="flex-row bg-gray-200 p-2 px-3 items-center rounded-3xl">
          ...
          <TextInput placeholder="Search..." placeholderTextColor={"#666666"} className="px-2" />
        </View>
      </View>
      ...
      <View className="mt-4">
        ...
        <ScrollView className="mt-4 ml-5" horizontal={true} showsHorizontalScrollIndicator={false}>
